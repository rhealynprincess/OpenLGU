...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo '<input type="time" name="time_start" value="'.$model->time_start.'" required="required"/>'?>
	</div>

	<div class="row">
	<?php echo $form->labelEx($model,'time_end'); ?>
	<?php echo '<input type="time" name="time_end" value="'.$model->time_end.'" required="required"/>'?>
	</div>
