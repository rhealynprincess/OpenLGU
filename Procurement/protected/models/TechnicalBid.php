...
/**
 * This is the model class for table "technical_bid".
 *
 * The followings are the available columns in table 'technical_bid':
 * @property integer $id
 ...
 * @property Bid $id0
 */
class TechnicalBid extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TechnicalBid the static model class
	 */
