...
/**
 * This is the model class for table "financial_bid".
 *
 * The followings are the available columns in table 'financial_bid':
 * @property integer $id
 ...
 * @property Bid $id0
 */
class FinancialBid extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return FinancialBid the static model class
	 */
