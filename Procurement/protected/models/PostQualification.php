...
/**
 * This is the model class for table "post_qualification".
 *
 * The followings are the available columns in table 'post_qualification':
 * @property integer $id
 ...
 */
class PostQualification extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PostQualification the static model class
	 */
