...
/**
 * This is the model class for table "loi_and_eligibility_receipt".
 *
 * The followings are the available columns in table 'loi_and_eligibility_receipt':
 * @property integer $id
 ...
 */
class LoiAndEligibilityReceipt extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LoiAndEligibilityReceipt the static model class
	 */
	...
	{
		return 'loi_and_eligibility_receipt';
	}
