...
*/
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Shortlist'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Shortlist');
	...
	{
		$model=new Shortlist('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Shortlist']))
			$model->attributes=$_GET['Shortlist'];
	...
	{
		$model=Shortlist::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='shortlist-form')
		{
