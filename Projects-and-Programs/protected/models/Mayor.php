 ...
 */
class Mayor extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Mayor the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('project_program_title, cost, location, source_of_fund, contractor, sector, date_started, date_completed, due_date, status,remarks', 'safe', 'on'=>'search'),
		);
	}
