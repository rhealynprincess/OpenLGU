...
class Taxpayer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('email, username, password, application_date, first_name, middle_name, last_name, dob_month, dob_day, dob_year, civil_status, gender, tin', 'required'),
			...
			array('username', 'unique', 'message'=>'Username has already been taken.'),
			...
			array('email, username, password, application_date, first_name, middle_name, last_name, suffix_name, full_name, dob_month, dob_day, dob_year, dob_full, civil_status, gender, tin, role, sys_entry_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('user_id, email, username, password, application_date, first_name, middle_name, last_name, suffix_name, full_name, dob_month, dob_day, dob_year, dob_full, civil_status, gender, tin, role, sys_entry_date', 'safe', 'on'=>'search'),
		);
	}
